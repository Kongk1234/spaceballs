      ...
      (function (e) {
        ...
        if ('Element' in e) {
          ...
          if (
            ...
            (c.add = function () {
              for (
                var e, t = arguments, o = 0, a = t.length, s = !1;
                ~d(this, (e = t[o] + '')) || (this.push(e), (s = !0)), ++o < a;
            ...
            var h = { get: m, enumerable: !0, configurable: !0 };
            try {
              s.defineProperty(a, t, h);
            } catch (e) {
              (void 0 !== e.number && -2146823252 !== e.number) ||
                ((h.enumerable = !1), s.defineProperty(a, t, h));
            }
      ...
      t.classList.add('c1', 'c2'),
        t.classList.contains('c2') ||
          ((e = function (e) {
            ...
            DOMTokenList.prototype[e] = function (e) {
              for (var t = arguments.length, o = 0; o < t; o++)
                (e = arguments[o]), a.call(this, e);
            };
          })('add'),
          e('remove')),
        ...
        'replace' in document.createElement('_').classList ||
          (DOMTokenList.prototype.replace = function (e, t) {
            ...
            ~a &&
              ((o = o.slice(a)),
              this.remove.apply(this, o),
              this.add(t),
              this.add.apply(this, o.slice(1)));
          }),
        (t = null);
    })());
var halfmoon = {
  ...
  getPreferredMode: function () {
    return this.readCookie('halfmoon_preferredMode')
      ? this.readCookie('halfmoon_preferredMode')
      : 'not-set';
  },
  toggleSidebar: function () {
    this.pageWrapper &&
      (this.pageWrapper.getAttribute('data-sidebar-hidden')
  ...
  deactivateAllDropdownToggles: function () {
    for (
      var e = document.querySelectorAll("[data-toggle='dropdown'].active"),
        t = 0;
      t < e.length;
      t++
    )
      e[t].classList.remove('active'),
        e[t].closest('.dropdown').classList.remove('show');
  },
  ...
  toastAlert: function (e, t) {
    ...
    void 0 === t && (t = 5e3),
      a.classList.contains('show') ||
        (a.classList.contains('alert-block') || a.classList.add('alert-block'),
        setTimeout(function () {
        ...
        setTimeout(function () {
          a.classList.remove('alert-block'),
  ...
  initStickyAlert: function (e) {
    ...
    r.setAttribute('id', this.makeId(6)),
      o && (t = "<h4 class='alert-heading'>" + o + '</h4>' + t),
      ...
      n &&
        (t =
          ...
          t),
      (r.innerHTML = t),
      this.stickyAlerts.insertBefore(r, this.stickyAlerts.childNodes[0]),
      this.toastAlert(r.getAttribute('id'), i);
  },
  clickHandler: function (e) {},
  keydownHandler: function (e) {},
};
function halfmoonOnDOMContentLoaded() {
  halfmoon.pageWrapper ||
    (halfmoon.pageWrapper = document.getElementsByClassName('page-wrapper')[0]),
    halfmoon.stickyAlerts ||
      (halfmoon.stickyAlerts =
        document.getElementsByClassName('sticky-alerts')[0]),
    halfmoon.readCookie('halfmoon_preferredMode')
      ? 'dark-mode' == halfmoon.readCookie('halfmoon_preferredMode')
        ? (halfmoon.darkModeOn = !0)
        : (halfmoon.darkModeOn = !1)
      : (window.matchMedia &&
          window.matchMedia('(prefers-color-scheme: dark)').matches) ||
        document.body.classList.contains('dark-mode')
      ? (halfmoon.darkModeOn = !0)
      : (halfmoon.darkModeOn = !1),
    (document.body.getAttribute('data-set-preferred-mode-onload') ||
      document.body.getAttribute('data-set-preferred-theme-onload')) &&
      (halfmoon.darkModeOn
        ? document.body.classList.contains('dark-mode') ||
          document.body.classList.add('dark-mode')
        : document.body.classList.contains('dark-mode') &&
    ...
    document.addEventListener(
      ...
      function (e) {
        var t,
          ...
          a = e,
          s = e.target;
        s.matches("[data-toggle='dropdown']") ||
        s.matches("[data-toggle='dropdown'] *")
          ? (s.matches("[data-toggle='dropdown'] *") &&
              (s = s.closest("[data-toggle='dropdown']")),
            s.classList.contains('active')
              ? (s.classList.remove('active'),
                s.closest('.dropdown').classList.remove('show'))
              : (halfmoon.deactivateAllDropdownToggles(),
                s.classList.add('active'),
                s.closest('.dropdown').classList.add('show')))
          : s.matches('.dropdown-menu *') ||
            halfmoon.deactivateAllDropdownToggles(),
          (s.matches(".alert [data-dismiss='alert']") ||
            s.matches(".alert [data-dismiss='alert'] *")) &&
            (s.matches(".alert [data-dismiss='alert'] *") &&
              (s = s.closest(".alert [data-dismiss='alert']")),
            s.parentNode.classList.add('dispose')),
          (s.matches("[data-toggle='modal']") ||
            s.matches("[data-toggle='modal'] *")) &&
            (s.matches("[data-toggle='modal'] *") &&
              (s = s.closest("[data-toggle='modal']")),
            (t = document.getElementById(s.getAttribute('data-target'))) &&
              t.classList.contains('modal') &&
              halfmoon.toggleModal(s.getAttribute('data-target'))),
          (s.matches(".modal [data-dismiss='modal']") ||
            s.matches(".modal [data-dismiss='modal'] *")) &&
            (s.matches(".modal [data-dismiss='modal'] *") &&
              (s = s.closest(".modal [data-dismiss='modal']")),
            s.closest('.modal').classList.remove('show')),
          s.matches('.modal-dialog') &&
            ((o = s.closest('.modal')).getAttribute(
              'data-overlay-dismissal-disabled'
            ) ||
              (o.classList.contains('show')
                ? o.classList.remove('show')
                : (window.location.hash = '#'))),
          halfmoon.clickHandler(a);
      },
      !1
    ),
    document.addEventListener('keydown', function (e) {
      ...
      document.querySelector('input:focus') ||
        ...
        (e = e || window.event).ctrlKey ||
        e.metaKey ||
        (document.body.getAttribute('data-sidebar-shortcut-enabled') &&
          e.shiftKey &&
          83 == e.which &&
          ((t = !1),
          window.location.hash &&
            ...
            (a = document.getElementById(o)) &&
              ...
              (t = !0)),
          document.querySelector('.modal.show') && (t = !0),
          t || (halfmoon.toggleSidebar(), e.preventDefault())),
        document.body.getAttribute('data-dm-shortcut-enabled') &&
          e.shiftKey &&
          68 == e.which &&
          (halfmoon.toggleDarkMode(), e.preventDefault())),
        27 === e.which &&
          (document.querySelector("[data-toggle='dropdown'].active")
            ? ((a = document.querySelector(
                "[data-toggle='dropdown'].active"
              )).classList.remove('active'),
              a.closest('.dropdown').classList.remove('show'),
              e.preventDefault())
            : (window.location.hash &&
                ((o = window.location.hash.substring(1)),
                (a = document.getElementById(o)) &&
                  a.classList.contains('modal') &&
                  (a.getAttribute('data-esc-dismissal-disabled') ||
                    ((window.location.hash = '#'), e.preventDefault()))),
              document.querySelector('.modal.show') &&
                ((a = document.querySelector('.modal.show')).getAttribute(
                  'data-esc-dismissal-disabled'
                ) ||
                  (a.classList.remove('show'), e.preventDefault())))),
        halfmoon.keydownHandler(s);
    });
  for (
    var e = document.querySelectorAll('.custom-file input'), t = 0;
    t < e.length;
    t++
  ) {
    var o = e[t],
    ...
    (a.innerHTML = s || 'No file chosen'),
      o.parentNode.appendChild(a),
      o.addEventListener('change', function (e) {
        (a = e.target.parentNode.querySelector('.file-names')),
          1 === e.target.files.length
            ? (a.innerHTML = e.target.files[0].name)
            : 1 < e.target.files.length
            ? (a.innerHTML = e.target.files.length + ' files')
            : (a.innerHTML = 'No file chosen');
      });
  }
  halfmoon.pageWrapper &&
